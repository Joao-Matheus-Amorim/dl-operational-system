...
- **Fase 3:** clientes, boards, calendario e tarefas do Meu Painel ja persistem
  no Supabase.
- **Fase 5:** Trello iniciado com importacao de board/listas/cards e envio
  controlado de cards.

## Ainda Fora do Corte Atual
- CRUD real de briefings, campanhas, arquivos, inbox, configuracoes,
  edicao/exclusao de eventos e tarefas fora do Meu Painel.
...
- **Fase 3:** repositorios de dados por dominio; clientes, boards, calendario
  e tarefas do Meu Painel entregues, demais dominios por cortar.
